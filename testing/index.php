...
$total_progress = 0;
// adventure
$stmtAdventure = new mysqli_stmt($mysqli, "SELECT a.id, a.description, v.adv_id, v.vote, p.file_ext, p.id, COUNT(vote) as rate FROM adventures A, votes V, photos P WHERE A.id = v.adv_id GROUP BY A.id ORDER BY v.vote DESC LIMIT 5");
if ($stmtAdventure) {
...
?>
    <div id="top1" class="container">
        <div class="row">
            <div class="col-md-3">
                <img
                    src="./img/contents/.<?php echo $photoExt; ?><?php echo $photoID; ?>"
