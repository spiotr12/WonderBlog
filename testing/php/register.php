...
//    $stmt = $mysqli->prepare("SELECT id FROM administrators WHERE email = ? LIMIT 1");
//    if ($stmt) {
...
//        $insert_stmt = $mysqli->prepare("INSERT INTO administrators (email, password, salt) VALUES (?, ?, ?)");
//        if ($insert_stmt) {
